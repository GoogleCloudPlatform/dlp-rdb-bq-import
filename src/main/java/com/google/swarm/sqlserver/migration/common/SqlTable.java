...
public class SqlTable implements Serializable {
  ...
  private String type;
  private long key;
  @Nullable private DLPProperties dlpConfig;
  ...
  public boolean equals(Object obj) {
    ...
    if (cloumnList == null) {
      if (other.cloumnList != null) return false;
    } else if (!cloumnList.equals(other.cloumnList)) return false;
    if (dlpConfig == null) {
      if (other.dlpConfig != null) return false;
    } else if (!dlpConfig.equals(other.dlpConfig)) return false;
