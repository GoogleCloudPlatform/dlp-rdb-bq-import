...
public class DLPProperties implements Serializable {
  ...
  @Nullable private String inspTemplate;
  ...
  public String toString() {
    return "DLPProperties [deidTemplate="
        + deidTemplate
        + ", inspTemplate="
        + inspTemplate
        + ", batchSize="
  ...
  public boolean equals(Object obj) {
    ...
    if (deidTemplate == null) {
      if (other.deidTemplate != null) return false;
    } else if (!deidTemplate.equals(other.deidTemplate)) return false;
    if (inspTemplate == null) {
      if (other.inspTemplate != null) return false;
    } else if (!inspTemplate.equals(other.inspTemplate)) return false;
    if (tableName == null) {
